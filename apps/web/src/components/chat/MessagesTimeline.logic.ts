...
export function shouldFocusComposerAfterResponseClick(input: {
  readonly selectionInResponse: boolean;
  readonly targetIsInteractive: boolean;
}): boolean {
  return !input.selectionInResponse && !input.targetIsInteractive;
}
